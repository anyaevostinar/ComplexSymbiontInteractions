...
#Read in the data
frameA <- read.table("munged_basic.dat", h=T)
frameB <- read.table("munged_basic2.dat", h=T)

frameC <- read.table("munged_basic3.dat", h=T)


onetwo <- rbind(frameA, frameB)
initial_data <- rbind(onetwo, frameC)
