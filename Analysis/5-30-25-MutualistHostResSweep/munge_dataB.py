...
folder = '../../Data/5-30-25-MutualistHostResSweep/'

treatment_postfixes = ["MOI0.0_REPRO10","MOI0.0_REPRO50","MOI0.0_REPRO75","MOI1.0_REPRO10","MOI1.0_REPRO50","MOI1.0_REPRO75"]
partners = ["Host", "Sym"]
tasks = ["NOT", "NAND", "AND", "ORN", "OR", "ANDN", "NOR", "XOR", "EQU"]
reps = range(15,30)
header = "uid treatment rep update task count partner\n"

outputFileName = "munged_basic15-30.dat"
