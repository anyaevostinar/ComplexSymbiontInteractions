...
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("CPU_CHANCE0.25", "25%", x)}))
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("CPU_CHANCE0.5", "50%", x)}))
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("CPU_CHANCE0.8", "80%", x)}))
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("CPU_CHANCE1", "100%", x)}))
