...
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("ORGANISM_TYPE0", "SGP", x)}))
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("ORGANISM_TYPE1", "Health", x)}))
