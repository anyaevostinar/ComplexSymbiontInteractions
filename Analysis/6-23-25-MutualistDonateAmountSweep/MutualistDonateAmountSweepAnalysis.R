...
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("CPU_AMOUNT2 ", "2 Donated", x)}))
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("CPU_AMOUNT5 ", "5 Donated", x)}))
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("CPU_AMOUNT10 ", "10 Donated", x)}))
initial_data[2] <- data.frame(lapply(initial_data[2], function(x) {gsub("CPU_AMOUNT20 ", "20 Donated", x)}))
