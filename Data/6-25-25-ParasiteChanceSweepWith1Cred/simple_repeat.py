...
for a in seeds:
    for b in donate_chance:
        command_str = './symbulation_sgp -SEED '+str(a)+ ' -CPU_TRANSFER_CHANCE ' +str(b)+ ' -FILE_NAME _CPU_CHANCE'+str(b)
        settings_filename = "Output_CPU_CHANCE"+str(b)+"_SEED"+str(a)+".data"
