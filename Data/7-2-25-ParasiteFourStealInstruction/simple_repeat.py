...
for a in seeds:
    for b in steal_instruction:
        command_str = './symbulation_sgp -SEED '+str(a)+ ' -DONATION_STEAL_INST ' +str(b)+ ' -FILE_NAME _DONATION_STEAL_INST'+str(b)
        settings_filename = "Output_DONATION_STEAL_INST"+str(b)+"_SEED"+str(a)+".data"
