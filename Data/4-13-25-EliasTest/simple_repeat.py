...
for a in seeds:
    for b in start_host_age:
        command_str = './symbulation_sgp -SEED '+str(a)+ ' -HOST_AGE_MAX ' +str(b)+ ' -FILE_NAME _AGE'+str(b)
        settings_filename = "Output_AGE"+str(b)+"_SEED"+str(a)+".data"
