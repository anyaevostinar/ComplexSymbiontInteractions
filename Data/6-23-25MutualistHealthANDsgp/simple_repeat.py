...
for a in seeds:
    for b in org_type:
        command_str = './symbulation_sgp -SEED '+str(a)+ ' -ORGANISM_TYPE ' +str(b)+ ' -FILE_NAME _ORGANISM_TYPE'+str(b)
        settings_filename = "Output_ORGANISM_TYPE"+str(b)+"_SEED"+str(a)+".data"
