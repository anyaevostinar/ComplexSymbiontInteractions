...
for a in seeds:
    for b in donate_chance:
        command_str = './symbulation_sgp -SEED '+str(a)+ ' -ONLY_FIRST_TASK_CREDIT ' +str(b)+ ' -FILE_NAME _ONLY_FIRST_TASK_CREDIT'+str(b)
        settings_filename = "Output_ONLY_FIRST_TASK_CREDIT"+str(b)+"_SEED"+str(a)+".data"
