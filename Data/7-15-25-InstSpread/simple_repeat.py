...
for a in seeds:
    for b in steal_amount:
        command_str = './symbulation_sgp -SEED '+str(a)+ ' -CPU_TRANSFER_AMOUNT ' +str(b)+ ' -FILE_NAME _AMOUNT'+str(b)
        settings_filename = "Output_AMOUNT"+str(b)+"_SEED"+str(a)+".data"
