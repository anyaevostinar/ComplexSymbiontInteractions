...
for a in seeds:
    for b in stress_type:
        command_str = './symbulation_sgp -SEED '+str(a)+ ' -STRESS_TYPE ' +str(b)+ ' -FILE_NAME _STRESS'+str(b)
        settings_filename = "Output_STRESS"+str(b)+"_SEED"+str(a)+".data"
