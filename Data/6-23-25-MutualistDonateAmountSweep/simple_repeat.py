...
for a in seeds:
    for b in donate_amount:
        command_str = './symbulation_sgp -SEED '+str(a)+ ' -CPU_TRANSFER_AMOUNT ' +str(b)+ ' -FILE_NAME _CPU_AMOUNT'+str(b)
        settings_filename = "Output_CPU_AMOUNT"+str(b)+"_SEED"+str(a)+".data"
